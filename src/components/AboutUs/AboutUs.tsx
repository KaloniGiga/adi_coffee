...
const AboutUs = () => {
  return (
    <div className="w-full sm:h-[80vh] lg:h-[80vh] px-8 py-8 flex justify-center items-center relative bg-white">
      {/* <div className="w-[30%] ml-auto h-full absolute inset-0 bg-[url('/')] bg-contain bg-center bg-no-repeat"></div> */}
      <div className="z-10 h-full w-[95%] lg:w-[90%] mx-auto flex flex-col-reverse justify-center lg:flex-row">
        ...
        <div className="w-full h-[50%] md:h-[50%] lg:w-[30%] lg:h-full">
          <Image
            src={"/aboutus2.png"}
            alt=""
            width={2000}
